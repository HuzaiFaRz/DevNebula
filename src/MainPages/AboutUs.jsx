    ...
    <div className="w-full min-h-screen bg-layout text-layoutText px-6 py-12 md:p-20 font-serif selection:bg-[#10b981]/30">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <p className="md:col-span-2 text-sm md:text-base text-[#f5f5f0]/80 leading-relaxed font-sans border-l border-layoutText/30 pl-4">
          ...
          <div className="grid grid-cols-3 md:grid-cols-1 gap-2 font-mono">
            {stats.map((s, i) => (
              ...
              >
                <span className="text-[9px] text-zinc-500 block">{s.l}</span>
                <span className="text-xs md:text-sm text-[#10b981] font-medium">
                  {s.v}
                </span>
              </div>
            ))}
